...
description: In this blog, I'll share with you an interesting coding exercise organized by my colleague (CoachA). This exercise takes around one hour and a half. I'll write down how it was going and what I've learned from it.
pubDate: 2021-12-20
lang: en
tags:
  - Java
  - Kata
slug: a-journey-of-javapath-coding-kata
---
...
public class Main {
    ...
    public static Object testJavaPath(String path, Object instance) {
        Map<String, Object> fieldToValue = Arrays
...
public class Main {
    public static Object testJavaPath(String path, Object instance) {
        ...
        for(String field : fields) {
            try {
                currentInstance = currentInstance.getClass()
...
public class Main {
    ...
    public static Object testJavaPath(String path, Object instance) {
        ...
        try {
            nextInstance = instance.getClass()
                .getDeclaredField(paths[0])
                .get(instance);
        } catch (IllegalAccessException | NoSuchFieldException e) {
            throw new RuntimeException(e);
        }
