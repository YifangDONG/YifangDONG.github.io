...
description: We all know that testing is essential for code quality. But when it comes to asynchronous code, things get complicated. Come and learn tips to avoid the headaches of unstable tests and improve your system's test coverage.
pubDate: 2020-06-28
lang: en
tags:
  - Java
  ...
  - Concurrency
  - Best practice
slug: how-to-test-an-asynchronous-request
---
...
If you want to run these examples locally or tweak them, the project is on GitHub: [github.com/YifangDONG/talk-async-test](https://github.com/YifangDONG/talk-async-test).
